...
namespace Gini\OAuth\Storage {
        ...
        \League\OAuth2\Server\Storage\ScopeInterface
    {
        ...
        public function createSession($clientId, $ownerType, $ownerId)
        {
            $db = $this->_db;
            $st = $db->query(
                'INSERT INTO _oauth_sessions (client_id, owner_type, owner_id) VALUES (:clientId, :ownerType, :ownerId)',
                null,
                [':clientId'=>$clientId, ':ownerType'=>$ownerType, ':ownerId'=>$ownerId]
            );
        ...
        public function deleteSession($clientId, $ownerType, $ownerId)
        {
            $db = $this->_db;
            $db->query(
                'DELETE FROM _oauth_sessions WHERE client_id=:clientId AND owner_type=:ownerType AND owner_id=:ownerId',
                null,
                [':clientId'=>$clientId, ':ownerType'=>$ownerType, ':ownerId'=>$ownerId]
            );
        }
        ...
        public function validateRefreshToken($refreshToken, $clientId)
        {
            ...
            return $st->count() > 0 ? $st->value() : false;
        }
        ...
        public function getAuthCodeScopes($oauthSessionAuthCodeId)
        {
            ...
            return $st->count() > 0 ? $st->rows(\PDO::FETCH_ASSOC) : [];
        }
        ...
        public function getScope($scope, $clientId = null, $grantType = null)
        {
            ...
            return $st->count() > 0 ? $st->row(\PDO::FETCH_ASSOC) : false;
        }
    }
